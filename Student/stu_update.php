...
$path="../Student/student_pro/".$imgname;
move_uploaded_file($imgfile,$path);


$query="UPDATE `students` SET `first_name`='$first_name',`last_name`='$last_name',`dob`='$dob ',`email`='$email',`contact_no`='$contact_no',`image`='$imgname' WHERE student_id='$id'";
