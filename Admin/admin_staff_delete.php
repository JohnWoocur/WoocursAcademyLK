            ...
            <div class="db-info-wrap">
                ...
                <div class="row">
                    ...
                    ?>
                       ...
                       &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                         view Staffs <a href ="admin_staff.php"> <span class="badge badge-success"><i class="fa fa-eye"></i></span></a></h4>
                        ...
                        $status = $row['status'];
                                ...
                                ?>
                                      <tr>
                                            ...
                                            <a href="a_staff_active.php?Sid=<?php echo"$sid";?>"><span class="badge badge-success"><i class="fa fa-check"></i></span>
                                            <!-- <a href="a_staff_delete.php?Sid="> <span class="badge badge-danger"><i class="fa fa-times"></i></span></a> -->
                                         </td>
                                        </tr>
                                        <?php
                                    }
