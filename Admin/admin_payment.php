                                ...
                                ?>
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td><a href="#"><span class="list-name"><?php echo "$name";?> </span></a>
                                            <!-- <span class="list-enq-city">United States</span> -->
                                            </td>
                                            <td><?php echo "$phone_no";?> </td>
                                            <td><?php echo "$email";?> </td>
                                            <td>
                                                <span class="badge badge-primary"><input type="image" name="slip"><?php echo "$image";?></span>
                                            </td>
                                            <td>
                                               <a href="admin_paymentlist.php"> <span class="badge badge-success">Approved</span></a>
                                                <a href="admin_paymentlist.php"><span class="badge badge-danger">Reject</span></a>
                                                <a href="view-payment.php"><span class="badge badge-primary">view</span></a>
                                            </td>
                                        </tr>
