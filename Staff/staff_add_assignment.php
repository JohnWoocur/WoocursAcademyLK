                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="dashboard-box">
                            ...
                            <form class="form-horizontal" method="POST" action="sta_add_assignment.php" enctype="multipart/form-data">
                                <div class="row">
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                    ...
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <input name="lid" class="form-control" type="text" required>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <input name="pdate" class="form-control" type="date" required>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <input name="ddate" class="form-control" type="date" required>
                                        </div>
                                    </div>
                                    <div class="col-sm-6"> 
                                        <div class="upload-input">
                                            <div class="form-group">
                                              <span class="upload-btn">Assignment File</span>
